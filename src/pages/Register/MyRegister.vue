<template>
    <div class="register-container">
        ...
        <div class="register">
            ...
            <div class="content">
                <label>确认密码:</label>
                <input type="password" placeholder="请输入确认密码" v-model="confirmPass" name="confirmPass"
                    v-validate="{ required: true, is: password }" :class="{ invalid: errors.has('confirmPass') }" />
        ...
        methods: {
            ...
            async getCode() {
                try {
                    ...
                    // 将组件的code属性值变为仓库中的验证码【这里验证码是直接自己填写的，实际上是要发到手机上，再由用户填写的】
