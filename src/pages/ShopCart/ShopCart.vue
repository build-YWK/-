        ...
        <div class="cart-tool">
            ...
            <div class="money-box">
                <div class="chosed">已选择
                    <span>{{ cartInfoList.length > 0 ? cartInfoList.length : 0 }}</span>件商品
                </div>
                <div class="sumprice">
                    <em>总价（不含运费） ：</em>
            ...
            handler: throttle(async function (type, disNum, cart) {
                ...
                switch (type) {
                    case 'add':
                        ...
                        break
                    case 'minus':
                        // 如果产品的个数大于1，给服务器传递的变化量为-1；如果产品的个数小于等于1，则给服务器传递的变化量为0（原封不动）
                        disNum = cart.skuNum > 1 ? -1 : 0
                        break
                    case 'change':
                        // 如果用户输入的最终量是非法的，那么带给服务器的变化量为0
